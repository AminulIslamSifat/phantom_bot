...
WEB_APP_URL = f"{WEBHOOK_URL.rstrip('/')}/panel" if WEBHOOK_URL else ""
ROUTINE_URL_ODD_WEEK = f"{WEB_APP_URL}/routine/odd"
ROUTINE_URL_EVEN_WEEK = f"{WEB_APP_URL}/routine/even"
